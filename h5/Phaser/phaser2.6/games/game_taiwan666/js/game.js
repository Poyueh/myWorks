...
game.State.boot = {
    preload: function () {
        game.load.image('loading', '../game_taiwan666/assets/preloader.gif');
        //行動平台螢幕適應
...
game.State.load = {
    preload: function () {
        ...
        game.load.image('bg', '../game_taiwan666/assets/background.jpg');
        game.load.image('ep01', '../game_taiwan666/assets/ep01.jpg');
        game.load.image('ep02', '../game_taiwan666/assets/ep02.jpg');
        game.load.image('ep03', '../game_taiwan666/assets/ep03.jpg');
        game.load.image('ep04', '../game_taiwan666/assets/ep04.jpg');
        game.load.image('ep05', '../game_taiwan666/assets/ep05.jpg');
        game.load.image('666', '../game_taiwan666/assets/666.jpg');
        ...
        game.load.atlas('dpad', '../game_taiwan666/assets/dpad.png', '../game_taiwan666/assets/dpad.json');

        /*****************************************************************/
        game.load.image('enemy', '../game_taiwan666/assets/enemy.png');
        /*****************************************************************/

        game.load.audio('start_bgm', '../game_taiwan666/sounds/start_bgm.mp3');
        game.load.audio('play_bgm', '../game_taiwan666/sounds/play_bgm.mp3');
        game.load.audio('boss_bgm', '../game_taiwan666/sounds/boss_bgm.mp3');
        game.load.audio('end_bgm', '../game_taiwan666/sounds/end_bgm.mp3');
        game.load.audio('type', '../game_taiwan666/sounds/type.mp3');
        game.load.audio('yes_I_do', '../game_taiwan666/sounds/yes_I_do.mp3');
        game.load.audio('level_up', '../game_taiwan666/sounds/level_up.mp3');
        game.load.audio('loss_bgm', '../game_taiwan666/sounds/loss_bgm.mp3');
        game.load.audio('get', '../game_taiwan666/sounds/get.mp3');
        game.load.audio('hurt', '../game_taiwan666/sounds/hurt.mp3');
        game.load.audio('die', '../game_taiwan666/sounds/die.mp3');
        game.load.audio('jump', '../game_taiwan666/sounds/jump.mp3');
        game.load.audio('explodeSFX', '../game_taiwan666/sounds/explode.mp3');
